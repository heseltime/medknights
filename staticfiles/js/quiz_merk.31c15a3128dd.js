$('form.box').ready(function(){
	...
	//cover info
	if ($('form.box > ul > li:first').hasClass('cover')) {
		//questions_left--; //does not count as q item
		
		//$('#questionsLeft').html(questions_left  + ' Fragen zum Set');
		
		$('form.box > ul > li.cover').append('<a class="button space_top magnify align_center">Zur Abrufephase</a>');
		
		//button functionality
		$('form.box > ul > li.cover > a.button').click(function() {
